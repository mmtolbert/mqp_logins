...
const displayCall = function() {
  // update background size
  document.getElementById("loginBackdrop").style.height = "400px"
  ...
  var verificationExplained = document.createElement("p")
  verificationExplained.innerHTML = "We will call you with a 6-digit verification code at <b>(***)***-**61</b>"
  verificationExplained.style.textAlign = "left"
...
const displayEmail = function() {
  ...
  verificationExplained.innerHTML = "An email with a 6-digit verification code was just sent to m********@gmail.com"
  verificationExplained.style.textAlign = "left"
  verificationExplained.style.padding = "0px 35px 0px 35px";
...
const displayTOTP = function() {
  ...
  // determine starting and ending indexes
  username_abbreviated.replace
  verificationExplained.innerHTML = "Get a verification code from the <b>Google Authenticator</b> app"
  verificationExplained.style.textAlign = "left"
  verificationExplained.style.padding = "0px 35px 0px 35px";
...
/* Push */
const displayPushWCode = function(json) {
  // update background size
  ...
  verificationTitle.style.padding = "0px 50px 0px 50px";
  var verificationExplained = document.createElement("p")
  verificationExplained.innerHTML = "Tap the number you see below in your <b>Google Authenticator</b> app to sign in."
  verificationExplained.style.textAlign = "left"
  verificationExplained.style.padding = "0px 50px 0px 50px";

  // deal with the numbers
  var num = document.createElement("p")
  num.innerHTML = "<b><span>" + json.num1 + "</span></b>"
  num.style.textAlign = "center"
  num.style.padding = "0px 50px 0px 50px";
  ...
  space.parentNode.insertBefore(verificationTitle, space)
  space.parentNode.insertBefore(verificationExplained, space)
  space.parentNode.insertBefore(num, space)
  document.getElementById("inputs").remove()

  // draw circles arond each number
  var cn = document.getElementById("num")
  $(cn).find('span').toggleClass('selected');
